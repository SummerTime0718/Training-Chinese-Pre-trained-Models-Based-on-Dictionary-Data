...
$ python -m train --compile=False --eval_iters=10 --batch_size=8
...
"""
dir = ['out/zh_data-20250326',
       'out/zh_data-20250402',
       'out/zh_data-20250507',
       'out/zh_data-20250706',
       'out/zh_data-20250514',
       'out/zh_data-20250607',
       'out/zh_data-20250611',
       'out/zh_data-20250617',
       'out/zh_data-20250626']
out_dir = dir[1]
...
max_seq_len = 256 # 模型最多可以處理的token數
...
if compile:
    ...
    model = torch.compile(model, backend="eager") # 1660Ti不支援triton
